...
WindowRendering::WindowRendering(HINSTANCE hInst, HWND parent, LPCWSTR Name, DWORD Style, int x, int y, int width, int height, LPCWSTR IconName, HCURSOR Cursor, EventListener*Listener)
{
	this->Listener = new EventListener(*Listener);
...
WindowData::WindowData(HWND Parent, HINSTANCE hInst, LPCWSTR Name, LPCWSTR Type, DWORD Style, WNDPROC Proc, int x, int y, int width, int height)
{
	this->Type = Type;
	this->Name = Name;
	this->Style = Style;
